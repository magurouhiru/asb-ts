  ...
  return v.parse(ValuesSchema, {
    health: round(
      cVpt(
        ...
        levels.health,
        imprinting,
        settings.StatImprintMultipliers.health,
    ...
    stamina: round(
      cVpt(
        ...
        levels.stamina,
        imprinting,
        settings.StatImprintMultipliers.stamina,
    ...
    oxygen: round(
      cVpt(
        ...
        levels.oxygen,
        imprinting,
        settings.StatImprintMultipliers.oxygen,
    ...
    food: round(
      cVpt(
        ...
        levels.food,
        imprinting,
        settings.StatImprintMultipliers.food,
    ...
    water: round(
      cVpt(
        ...
        levels.water,
        imprinting,
        settings.StatImprintMultipliers.water,
    ...
    temperature: round(
      cVpt(
        ...
        levels.temperature,
        imprinting,
        settings.StatImprintMultipliers.temperature,
        settings.statMultipliers.temperature,
        settings,
      ),
    ),
    weight: round(
      cVpt(
        ...
        levels.weight,
        imprinting,
        settings.StatImprintMultipliers.weight,
    ...
    meleeDamageMultiplier: round(
      cVpt(
        ...
        levels.meleeDamageMultiplier,
        imprinting,
        settings.StatImprintMultipliers.meleeDamageMultiplier,
        settings.statMultipliers.meleeDamageMultiplier,
        settings,
      ),
      PRECISION_1000,
    ...
    speedMultiplier: round(
      cVpt(
        ...
        levels.speedMultiplier,
        imprinting,
        settings.StatImprintMultipliers.speedMultiplier,
        settings.statMultipliers.speedMultiplier,
        settings,
      ),
    ),
    temperatureFortitude: round(
      cVpt(
        ...
        levels.temperatureFortitude,
        imprinting,
        settings.StatImprintMultipliers.temperatureFortitude,
        settings.statMultipliers.temperatureFortitude,
        settings,
      ),
    ),
    craftingSpeedMultiplier: round(
      cVpt(
        ...
        levels.craftingSpeedMultiplier,
        imprinting,
        settings.StatImprintMultipliers.craftingSpeedMultiplier,
        settings.statMultipliers.craftingSpeedMultiplier,
        settings,
      ),
    ),
    torpidity: round(
      cVpt(
        ...
        levels.torpidity,
        imprinting,
        settings.StatImprintMultipliers.torpidity,
        settings.statMultipliers.torpidity,
        settings,
      ),
    ),
...
function cVpt(
  ...
  const tmp1 = vw * tbhm * (1 + imprinting * imprintMultiplier * IBM);
