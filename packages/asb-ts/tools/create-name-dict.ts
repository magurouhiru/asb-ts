...
const DICT_JA: NameDict = [
  ...
  { source: "Wyvern", translation: "アイスワイバーン" },
  ...
  { source: "Extinction", translation: "(特定条件で攻撃的)" },
  ...
  { source: "The Island", translation: "(特定条件で攻撃的)" },
  ...
  { source: "Drakeling", translation: "ウィンター・ドレイクリング" },
  { source: "", translation: "エクウス" },
  { source: "Equus", translation: "ユニコーン" },
  ...
  { source: "Drakeling", translation: "オータム・ドレイクリング" },
  ...
  { source: "Drakeling", translation: "サマー・ドレイクリング" },
  ...
  { source: "Drakeling", translation: "スプリング・ドレイクリング" },
  { source: "Thrall", translation: "スロール" },
  { source: "Lost Colony", translation: "(特定条件で攻撃的)" },
  ...
  { source: "Extinction", translation: "(特定条件で攻撃的)" },
  { source: "", translation: "ドレッドメア" },
  { source: "Dreadmare,", translation: "ドレッドスタリオン" },
  { source: "肉食", translation: "Dreadstallion" },
  { source: "Troodon", translation: "トロオドン" },
  { source: "Cat", translation: "猫" },
  { source: "", translation: "友好的、" },
  { source: "", translation: "テリトリー型、" },
  { source: "The Island", translation: "攻撃的" },
  ...
  { source: "Scorched Earth", translation: "(特定条件で攻撃的)" },
  ...
  { source: "The Island", translation: "(特定状況で攻撃的)" },
  { source: "Ovis", translation: "ヒツジ" },
  { source: "Leech", translation: "ヒル" },
  { source: "Wyvern", translation: "ファイアワイバーン" },
  ...
  { source: "Genesis Part 1", translation: "（特定条件で攻撃的）" },
  ...
  { source: "Wyvern", translation: "ポイズンワイバーン" },
  ...
  { source: "Scorched Earth", translation: "(特定条件で受動的)" },
  ...
  { source: "Wyvern", translation: "ライトニングワイバーン" },
